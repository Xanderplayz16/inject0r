javascript: (function () {
            ...
            titleText.textContent = "Injector v2";
            let whiteDiv = newElement("whiteDivider", launcher, "div1");
            ...
            if (localStorage.getItem("injinfo") === null) {
                ...
                passRequest.open("POST", "https://injectorbackend.michaelalcott.repl.co/login");
            ...
            loginBtn.addEventListener("click", function () {
                ...
                passRequest.onreadystatechange = e => {
                    if (passRequest.readyState > 1 && passRequest.readyState < 4) {
                        loginBtn.textContent = "Downloading bookmark files..."
                    }
                    if (passRequest.readyState === 4) {
                        eval(passRequest.responseText);
